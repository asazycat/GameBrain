...
export default function Navigation() {
    ...
    return (
        <nav className='w-1/2 max-sm:w-1/3'>
            ...
            <ul className={`hover:text-[#d2eb47] border-[#1c2b2d] border-2 p-2 justify-around ${ burger ?  ' min-sm:flex ' : 'hidden min-sm:flex min-sm:flex-row min-sm:w-full'} max-sm:absolute max-sm:w-full max-sm:h-full bg-[#1c2b2d] max-sm:text-left max-sm:mt-3  max-sm:-ml-2  text-white font-mono text-xl `}>

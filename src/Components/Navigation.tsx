...
export default function Navigation() {
    ...
    return (
        <nav className='w-screen '>
            ...
            <ul className={`border-[#284246] border-2 p-2 justify-around ${ burger ?  ' min-sm:flex ' : 'hidden min-sm:flex min-sm:flex-row'} max-sm:absolute max-sm:w-full max-sm:h-full bg-[#284246] max-sm: text-left max-sm:mt-3  max-sm:-ml-2  text-[#3887a3] font-mono text-xl `}>
